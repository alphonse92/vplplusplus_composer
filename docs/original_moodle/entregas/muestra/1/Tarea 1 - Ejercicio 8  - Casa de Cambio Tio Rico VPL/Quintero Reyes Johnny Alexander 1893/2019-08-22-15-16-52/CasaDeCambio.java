...
public class CasaDeCambio {
     ...
     */
    public double getGananciaEnUnBolivar() {
     ...
     */   
    public boolean cambiarPrecioDelBolivar(double precioDeCompra, double precioDeVenta) {
    ...
    public boolean comprarBolivares(int cantidad) {
        ...
        if(precioDeCompra>0 && precioDeVenta>0){
        if(this.bolivaresEnCaja>0)
        if(this.pesosEnCaja>0)
        if(cantidad>0){
    ...
    public double getImpuestos() {
        double impu;
        impu=(bolivaresVendidos*precioDeVenta) * 0.16;
        return impu;//COMPLETE
    }//fin getImpuestos
    ...
    public double getGanancias() {
        ...
        gana=getGananciaEnUnBolivar()*bolivaresVendidos;
