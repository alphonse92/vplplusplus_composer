public class Hora {
    ...
    public boolean esHoraValida() {
        //COMPLETE
        if((this.horas>=0&&this.minutos>=0&&this.segundos>=0)&&(this.horas<=23&&this.minutos<=59&&this.segundos<=59))
        return true;
        else
        return false;
    }
    ...
    public double restar(Hora otra) {
      //COMPLETE
      double resta;
      resta=(this.horas + this.minutos/60 + this.segundos/3600)-(otra.horas + otra.minutos/60 + otra.segundos/3600); 
      return resta;
    }
