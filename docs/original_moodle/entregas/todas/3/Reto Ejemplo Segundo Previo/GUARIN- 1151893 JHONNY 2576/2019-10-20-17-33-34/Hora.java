/**
 * Clase Hora - Ejemplo de segundo parcial :D.
 *
...
public class Hora {
    ...
    public boolean esHoraValida() {
        return (this.horas >= 0 && this.horas <= 23 && this.minutos >= 0 
            && this.minutos <= 59 && this.segundos >= 0 && this.segundos <= 59); 
    }
    ...
    public double restar(Hora otra) {
        return restarEnSegundos(otra)/3600d;
    }
    ...
    public long restarEnSegundos(Hora other) {
        long restaEnSegundos = this.horas*3600 - other.horas*3600 +this.minutos*60 - other.minutos*60 + this.segundos - other.segundos;
        return restaEnSegundos;
    }
