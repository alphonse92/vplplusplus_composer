...
public class CampeonatoTest
{
    ...
    @Test
    public void testCampeonatoInscribirEquipo()
    {
    ...
    @Test
    public void testCampeonatoRegistrarPartido(){
        Campeonato c = new Campeonato();
    ...
    @Test
    public void testCampeonatoBuscarEquipo()
    {
        Campeonato c = new Campeonato();
    ...
    @Test
    public void testCampeonatoConstructor()
    {
        Campeonato c = new Campeonato();
