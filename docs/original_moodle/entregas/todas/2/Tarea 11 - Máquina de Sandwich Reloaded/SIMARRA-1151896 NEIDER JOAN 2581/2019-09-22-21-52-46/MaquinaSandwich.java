...
class MaquinaSandwich {
    ...
    public void registrarVenta(int tipoSandwich, int tipoPan) {
       ...
       if((tipoSandwich==1)&&(tipoPan==1)){
         ...
         if(CantidadQueso<15) throw new RuntimeException("Mensaje de Error");
         this.cantidadMortadela=cantidadMortadela-10;
         if(cantidadMortadela<10) throw new RuntimeException("Mensaje de Error");
         this.cantidadPanBlanco=cantidadPanBlanco-1;
         if(cantidadPanBlanco<1)  throw new RuntimeException("Mensaje de Error");
        ...
        if((tipoSandwich==2)&&(tipoPan==1)){
         ...
         if(cantidadJamon<10) throw new RuntimeException("Mensaje de Error");
         this.cantidadPanBlanco=cantidadPanBlanco-1;
         if(cantidadPanBlanco<1) throw new RuntimeException("Mensaje de Error");
         ...
         if(cantidadQueso<30)  throw new RuntimeException("Mensaje de Error");
         this.cantidadMortadela=cantidadMortadela-20;
         if(cantidadQueso<20)  throw new RuntimeException("Mensaje de Error");
         this.cantidadPanBlanco=cantidadPanBlanco-2;
         if(cantidadPanBlanco<2) throw new RuntimeException("Mensaje de Error");
         ...
         if(cantidadJamon<20)  throw new RuntimeException("Mensaje de Error");
         this.cantidadPanBlanco=cantidadPanBlanco-2;
         if(cantidadPanBlanco<2)  throw new RuntimeException("Mensaje de Error");
         calcularPrecioVenta(4,1);
          ...
          if(cantidadQueso<45)  throw new RuntimeException("Mensaje de Error");
         this.cantidadMortadela=cantidadMortadela-30;
         if(cantidadMortadela)  throw new RuntimeException("Mensaje de Error");
         this.cantidadPanBlanco=cantidadPanBlanco-3;
         if(cantidadPanBlanco<3) throw new RuntimeException("Mensaje de Error");
         ...
         this.cantidadPanBlanco=cantidadPanBlanco-3;
         if(cantidadanBlanco<3) throw new RuntimeException("Mensaje de Error");
