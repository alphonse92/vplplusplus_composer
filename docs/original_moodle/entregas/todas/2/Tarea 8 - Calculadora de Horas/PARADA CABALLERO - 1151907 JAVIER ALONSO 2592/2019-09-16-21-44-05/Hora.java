...
public class Hora
{
    ...
    public Hora(int horas, int minutos, int segundos, String ampm) {
     ...
     this.minutos = minutos=00;
     this.segundos = segundos=00;
     if(this.ampm=="a.m."){this.ampm = ampm="a.m.";this.horas = horas=01;}
     if(this.ampm=="p.m."){this.ampm = ampm="p.m.";this.horas = horas=01;}
    }
    ...
    protected boolean esHoraValida(){
        boolean validarH=false;
        if(this.formato=="HH12"&& horas<=12 && horas>=01 && minutos<60 && segundos<60){validarH=true;}
        if(this.formato=="HH24"&& horas<=24 && horas>=00 && minutos<60 && segundos<60){validarH=true;}
        return validarH;
    }
    ...
    public int restar(Hora other){
        int resta=(this.horas-horas)*3600;
        if(this.horas<horas){resta=resta*-1;}
        if(this.horas==horas){resta=0;}
        return resta;//COMPLETE
    }
    ...
    public boolean esIgual(Hora other){
        boolean igual=false;
        if(this.horas==horas && this.formato==formato){igual=true;}
        return igual;
    }
    ...
    */
    public void setFormato(String formato){
     ...
     if(this.formato=="HH12" && this.horas<12){this.horas=this.horas+12;this.formato="HH24";ampm=null;}
     if(this.formato=="HH12" && this.horas==12){this.horas=00;this.formato="HH24";ampm=null;}
