...
public class Hora
{
    ...
    protected boolean esHoraValida(){
        ...
        if(this.formato == null) return false;
        if(this.formato.equals(this.HH24))
            return (this.horas >= 0 && this.horas < 24) && (this.minutos >= 0 && this.minutos < 60) && (this.segundos >= 0 && this.segundos < 60);
        else{
                if(this.formato.equals(this.HH12)){
                    return (this.horas > 0 && this.horas < 13) && (this.minutos >= 0 && this.minutos < 60) && (this.segundos >= 0 && this.segundos < 60)
                            && (this.ampm == AM || this.ampm == PM);
                }
                else return false;
            }       
        /*if(this.formato == null) return false;
        if(this.formato.equals(HH12) && this.horas == 0 || this.horas > 12 || this.minutos > 59 || this.segundos > 59) return false;
        else if(this.formato.equals(HH24) && this.horas > 23 || this.minutos > 59 || this.segundos > 59) return false;
        return true;*/
        //COMPLETE
    }
    ...
    public Hora getHoraHH24(){
        if(this.formato==HH24) return this;
        else{
            Hora salida = this;
            salida.setFormato(this.HH24);
            return salida;
        }
      //COMPLETE
    }
    ...
    public Hora getHoraHH12(){
        if(this.formato==HH12) return this;
        else{
            Hora salida = this;
            salida.setFormato(this.HH12);
            return salida;
        }
      //COMPLETE
    }
    ...
    public int restar(Hora other){
        int tSegundos = 0;
        int oSegundos = 0;
        Hora tHora = this.getHoraHH24();
        Hora oHora = other.getHoraHH24();
        tSegundos = tHora.horas * 3600 + tHora.minutos * 60 + tHora.segundos;
        oSegundos = oHora.horas * 3600 + oHora.minutos * 60 + oHora.segundos;
      return tSegundos - oSegundos;//COMPLETE
    }
    ...
    */
    public void setFormato(String formato){    
        ...
        if(this.formato == this.HH12 && formato == this.HH24){
            if(this.horas == 12){
                if(this.ampm == PM) this.horas = 12;
                else this.horas = 0;
            }
            this.formato = HH24;
        }
        else if(this.ampm == PM) this.horas += 12;
        
        if(this.formato.equals(this.HH24) && formato.equals(HH12)){
            if(this.horas == 0) {
                this.horas = 12;
                this.ampm = this.AM;
            }
