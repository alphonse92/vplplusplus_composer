...
public class Hora
{
    ...
    protected boolean esHoraValida(){
        ...
        if(this.formato==HH12 && horas>=1 && horas<=12 && minutos>=0 && minutos<=59 && segundos>=0 && segundos<=59 && (ampm==AM ||ampm==PM)){
            valida = true;
        }
        else if(this.formato==HH24 && horas>=0 && horas<=23 && minutos>=0 && minutos<=59 && segundos>=0 && segundos<=59){
            valida = true;
        }
        else{
            valida = false;
    ...
    public Hora getHoraHH24(){
        this.formato=HH24;
        Hora hh24 = new Hora(this.horas, this.minutos, this.segundos, this.formato);
        return hh24;
    }
    ...
    public Hora getHoraHH12(){
        this.formato=HH12;
        Hora hh12 = new Hora(this.horas, this.minutos, this.segundos, this.formato, this.ampm);
        return hh12;
    }
    ...
    public int restar(Hora other){
     ...
     if(other.formato.equals(this.HH12)){
         other.formato = this.HH24;
    if(other.ampm.equals(this.PM)){
        if (other.horas == 12); 
        else
        other.horas += 12;
    }
        ...
        return this.horas*3600 - horas*3600 + this.minutos*60 - minutos*60 + this.segundos - segundos;
    }
    ...
    public boolean esIgual(Hora other){
        boolean igual=true;
        other = new Hora(horas, minutos, segundos);
        if(this==other){
            igual=true;
        }
        else{
    ...
    public boolean esMenor(Hora other){
      boolean menor=false;
        if(this.horas<horas && this.formato==formato){menor=true;}
        return menor;
    }   
    ...
    boolean mayor=false;
        if(this.horas>horas ){mayor=true;}
        return mayor;
    }
     ...
     * Ejemplos:
     * Si this es 00:05:06 y formato es HH24 debe retornar 12:05:06 a.m. en formato HH12
     * Si this es 12:01:02 a.m. y formato es HH12 debe retornar 00:01:02 en formato HH24
     * @param formato Puede ser HH24 o HH12
     */
     public void setFormato(String formato){
     if(this.formato==this.HH24){
     if(this.horas<12){this.horas=12-horas;this.formato=HH12;ampm="a.m.";}
     if(this.horas==12){this.horas=12;this.formato=HH12;ampm="p.m.";}
     if(this.horas>12 ){this.horas=this.horas-12;this.formato=HH12;ampm="p.m.";}}
     if(this.formato==this.HH12 && this.horas<12){this.horas=this.horas+12;this.formato=HH24;ampm=null;}
     if(this.formato==this.HH12 && this.horas==12){this.horas=00;this.formato=HH24;ampm=null;}
