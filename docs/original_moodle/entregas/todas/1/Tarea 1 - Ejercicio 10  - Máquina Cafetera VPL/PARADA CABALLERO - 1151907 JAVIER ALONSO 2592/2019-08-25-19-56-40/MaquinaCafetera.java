public class MaquinaCafetera
{
  ...
  public int getCafe() { return this.cafe; }
  
  public void setCafe(int cafe) { this.cafe = cafe; }

  public int getAzucar() { return this.azucar; }
  
  public void setAzucar(int azucar) { this.azucar = azucar; }
  
  public int getVasos() { return this.vasos; }
 
  public void setVasos(int vasos) { this.vasos = vasos; }

  public int getEgresos() { return this.egresos; }
  ...
  public int getGananciasBrutas() { return this.gananciasBrutas; }
 
  public void setGananciasBrutas(int gananciasBrutas) { this.gananciasBrutas = gananciasBrutas; }

  public int getImpuestos() { return this.impuestos; }
 
  public void setImpuestos(int impuestos) { this.impuestos = impuestos; }
  
  public int getGananciasNetas() { return this.gananciasNetas; }

  public void setGananciasNetas(int gananciasNetas) { this.gananciasNetas = gananciasNetas; }
 
  public int getPrecioBaseCafe() { return this.precioBaseCafe; }
 
  public void setPrecioBaseCafe(int precioBaseCafe) { this.precioBaseCafe = precioBaseCafe; }
