...
class MaquinaCafetera { 
    ...
    MaquinaCafetera(int cafe, int azucar, int vasos, int precioBaseCafe, int egresos, int ingresos, int gananciasBrutas, int impuestos, int gananciasNetas){
        this.cafe = cafe;
        this.azucar= azucar;
        this.vasos= vasos;
    ...
    public void registrarFactura(int valorFactura) {
        ...
        gananciasBrutas +=valorFactura;
        gananciasBrutas -= egresos;
