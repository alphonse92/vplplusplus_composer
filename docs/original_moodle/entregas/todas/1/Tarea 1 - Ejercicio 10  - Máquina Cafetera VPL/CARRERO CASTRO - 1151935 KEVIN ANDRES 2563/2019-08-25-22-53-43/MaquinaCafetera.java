...
{ 
    ...
    public boolean prepararCafe(int tipoCafe, int cantidadAzucar) 
    {
        boolean prepararCafe=false;
            ...
            if((tipoCafe==2 && cantidadAzucar==1) && (this.cafe>=110 && this.vasos>0))
            {
                prepararCafe=true;
                this.cafe-=110;
                this.vasos--;
            }
            if((tipoCafe==2 && cantidadAzucar==2) && (this.cafe>=110 && this.azucar>=5 && this.vasos>0))
            {
                prepararCafe=true;
                this.cafe-=110;
                this.azucar-=5;
            ...
            if((tipoCafe==2 && cantidadAzucar==3) && (this.cafe>=110 && this.azucar>=10 && this.vasos>0))
            {
                prepararCafe=true;
                this.cafe-=110;
                this.azucar-=10;
            ...
            if((tipoCafe==3 && cantidadAzucar==1) && (this.cafe>=165 && this.vasos>0))
            {
                prepararCafe=true;
                this.cafe-=165;
                this.vasos--;
            }
            if((tipoCafe==3 && cantidadAzucar==2) && (this.cafe>=165 && this.azucar>=5 && this.vasos>0))
            {
                prepararCafe=true;
                this.cafe-=165;
                this.azucar-=5;
            ...
            if((tipoCafe==3 && cantidadAzucar==3) && (this.cafe>=165 && this.azucar>=10 && this.vasos>0))
            {
                prepararCafe=true;
                this.cafe-=165;
                this.azucar-=10;
