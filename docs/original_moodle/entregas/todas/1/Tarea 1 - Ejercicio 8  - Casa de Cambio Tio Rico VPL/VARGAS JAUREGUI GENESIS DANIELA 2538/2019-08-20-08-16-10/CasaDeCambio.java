...
public class CasaDeCambio {
    ...
    public boolean comprarBolivares(int cantidad) {
        ...
        puedeComprar = (cantidad * precioDeCompra <= pesosEnCaja && cantidad > 0);
        if(puedeComprar){
    ...
    public boolean venderBolivares(int cantidad) {
        ...
        puedeVender = cantidad <= bolivaresEnCaja && cantidad > 0;
    ...
    public float getImpuestos() {
        return (getBolivaresVendidos () * getPrecioDeVenta ()  * 0.16f);//COMPLETE
    }//fin getImpuestos
