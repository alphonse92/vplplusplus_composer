/**
 * Un ejemplo que modela una Casa de Cambio de Bolivares usando POO
 * 
 * @author (Milton JesÃšs Vera Contreras)
...
public class CasaDeCambio {
    ...
    public float getGanancias() {
        return bolivaresVendidos*precioDeVenta - getImpuestos();//COMPLETE
    }//fin getGanancias
