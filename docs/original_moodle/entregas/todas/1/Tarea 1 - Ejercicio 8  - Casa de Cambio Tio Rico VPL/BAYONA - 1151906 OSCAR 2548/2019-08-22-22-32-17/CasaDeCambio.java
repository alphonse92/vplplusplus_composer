...
public class CasaDeCambio {
    ...
    public boolean cambiarPrecioDelBolivar(float precioDeCompra, float precioDeVenta) {
        ...
        //COMPLETE
        float ganancia =precioDeVenta - precioDeCompra;
        if (precioDeCompra>0&&precioDeVenta>0&&ganancia>0){
          precioValido = true;
    ...
    public boolean comprarBolivares(int cantidad) {
        ...
        if (pesosEnCaja>=cantidad*precioDeCompra){
         this.bolivaresComprados= this.bolivaresComprados+(cantidad);
    ...
    public boolean venderBolivares(int cantidad) {
        ...
        //COMPLETE
        if (bolivaresEnCaja>=cantidad*precioDeVenta){
    ...
    public float getImpuestos() {
        float impuestos = (bolivaresVendidos*precioDeVenta*16)/100;
        return impuestos*precioDeCompra;//COMPLETE
    }//fin getImpuestos
    ...
    public float getGanancias() {
        float impuestos = getImpuestos();
        return (pesosEnCaja)-impuestos;//COMPLETE
    }//fin getGanancias
