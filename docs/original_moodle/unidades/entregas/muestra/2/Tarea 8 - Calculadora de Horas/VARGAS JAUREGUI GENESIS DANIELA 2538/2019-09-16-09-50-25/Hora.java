 ...
 * @desarrolladores (Paula Valentina Rico Lindarte && Génesis Daniela Vargas Jáuregui && Jhonny Esneider Guarin Chávez)
...
public class Hora
{
    ...
    protected boolean esHoraValida(){
        ...
        if (this.formato.equals(this.HH24)){
            ...
            if (this.formato.equals(this.HH12)){
                return (this.horas> 0 && this.horas <= 12) && (this.minutos>=0 && this.minutos <= 59) && 
                (this.segundos>=0 && segundos <= 59) && (this.ampm==AM || this.ampm==PM);
            }
    ...
    public Hora getHoraHH24(){
        ...
        Hora hora = new Hora(this.horas, this.minutos, this.segundos, this.formato, this.ampm);
        return hora;
    }
    ...
    public boolean esMenor(Hora other){
        ...
        if((this.horas < other.horas) || (this.horas == other.horas && this.minutos < other.minutos) || 
           (this.horas == horas && this.minutos == other.minutos && this.segundos < other.segundos)) return true;
           else return false;
    }  
    ...
    public void setFormato(String formato){
        if(!(formato.equals(this.formato))){
            if(formato.equals(this.HH24)){
                this.formato = this.HH24;
                if(getAmpm().equals(this.PM)){
                    if(getHoras() == 12);
                    else
                        this.horas += 12; 
                }
                else{
                    if(getHoras() == 12) this.horas = 0;
                }
            }
            else if(formato.equals(this.HH12)){
                this.formato = HH12;
                if(getHoras() >= 12){
                    this.ampm = this.PM;
                    if(getHoras() != 12) 
