...
public class Universidad
{
    ...
    public boolean agregarMateria(String nombre, int maximoDeAlumnosPorGrupo)
    {
        ...
        Materia mat =  new Materia(nombre, maximoDeAlumnosPorGrupo);
        if(contadorMaterias < this.materias.length && !contieneMateria(mat)){
            this.materias[contadorMaterias++] = mat;
            return true;
        }
        return agrego;
        
        
        /*if(contieneMateria(mat) || contadorMaterias == MAX_MATERIAS) return false;
        else materias[contadorMaterias++] = mat;       
        //COMPLETE
        return agrego;*/
    }//fin agregarMateria
