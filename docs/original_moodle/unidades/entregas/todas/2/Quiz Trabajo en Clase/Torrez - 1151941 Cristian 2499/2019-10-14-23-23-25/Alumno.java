...
public class Alumno{
    ...
    public boolean equals(Object other){
        if(other instanceof String) {
            return other.equals(this.codigo);
        }
        
        if(other instanceof Alumno) {
            Alumno alumno = (Alumno) other;
            
            return alumno.getCodigo().equals(this.codigo) || (alumno.getNombres().equals(this.nombres) && alumno.getApellidos().equals(this.apellidos));
        }
