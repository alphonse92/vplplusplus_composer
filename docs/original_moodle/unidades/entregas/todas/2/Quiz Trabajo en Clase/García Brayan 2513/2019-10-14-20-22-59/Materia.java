...
public class Materia
{
    ...
    public boolean inscribir(Alumno alumno)
    {
        ...
        if(!alumno.tienePromedioCondicional() && !this.inscripciones.contains(inscripcion )){
    ...
    public int generarGrupos()
    {
        ...
        for(int i=0; i<totalGrupos; i++){
            this.grupos.add(new Grupo(this));
        }
        ...
        for(int i=0; i<totalGrupos; i++)
        {
            ...
            {
                this.grupos.get(i).agregarAlumno(this.inscripciones.get(k++).getAlumno());
            }//fin for j
        }//fin for i
        return totalGrupos;
    }//fin generarGrupos
    ...
    public boolean equals(Object other)
    {
        ...
        {
            equals = this.nombre.equals(other);
        }
        if(other instanceof Materia)
        {
            equals = this.nombre.equals(((Materia)other).getNombre());
        }
        return equals;
    }//fin equals
