/**
 *
 * @author (Paula Valentina Rico Lindarte 1151910)
...
class MaquinaSandwich {
     ...
     */
    MaquinaSandwich() {
        this.cantidadQueso = this.CANTIDAD_BASE_QUESO;
        this.cantidadMortadela = this.CANTIDAD_BASE_MORTADELA_JAMON;
        this.cantidadJamon = this.CANTIDAD_BASE_MORTADELA_JAMON;
        this.cantidadPanBlanco = this.CANTIDAD_BASE_PAN;
        this.cantidadPanIntegral = this.CANTIDAD_BASE_PAN;
    }
