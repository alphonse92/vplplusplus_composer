...
public class Hora
{
    ...
    public Hora(int horas, int minutos, int segundos)  {
        this(horas, minutos, segundos, HH24, AM);
    ...
    public Hora getHoraHH24(){
      ...
      h1.formato = HH24;
      h1.horas = this.horas;  
      h1.minutos = this.minutos;
      h1.segundos = this.segundos;
      if(this.ampm==PM)
        h1.horas+=12;
      return h1;
    }
    ...
    public Hora getHoraHH12(){
      ...
      h2.formato = HH12;
      h2.horas = this.horas;  
      h2.minutos = this.minutos;
      h2.segundos = this.segundos;
      if(this.horas>12){
        h2.horas-=12;
        h2.ampm = PM;
      }
