...
public class Hora
{
    ...
    public Hora getHoraHH24(){
        Hora get24 = new Hora(this.horas, this.minutos, this.segundos, this.formato, this.ampm);
        
        get24.setFormato(HH24);
    ...
    public Hora getHoraHH12(){
        ...
        Hora get12 = new Hora(this.horas, this.minutos, this.segundos, this.formato, this.ampm);
        get12.setFormato(HH12);
    ...
    public int restar(Hora other){
        ...
        s1=this.horas*3600+this.minutos*60+this.segundos;
        s2=other.horas*3600+other.minutos*60+other.segundos;
        resta = s1-s2;
