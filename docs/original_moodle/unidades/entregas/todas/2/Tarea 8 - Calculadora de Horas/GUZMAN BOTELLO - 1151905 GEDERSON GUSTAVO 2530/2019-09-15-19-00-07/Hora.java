...
public class Hora
{
    ...
    protected boolean esHoraValida(){
        ...
        if (this.horas < 0 || this.minutos < 0 || this.minutos > 59 || this.segundos < 0 || this.segundos > 59 || ((this.formato != HH24) && (this.formato != HH12))) horaValida = false;
        if ((this.formato == HH12) && ((this.horas == 0) || (this.horas > 12) || (this.ampm != AM && this.ampm != PM)) horaValida = false;
        if ((this.formato == HH24) && (this.horas > 23) && (this.ampm != null)) horaValida = false;
        return horaValida;//COMPLETE
    }
    ...
    public Hora getHoraHH24(){
        Hora copiahora = new Hora();
        if (this.formato == HH12) setFormato(HH24);
        copiahora.horas = this.horas;
        copiahora.minutos = this.minutos;
        copiahora.segundos = this.segundos;
        copiahora.formato = HH24;
        copiahora.ampm = "";
      return copiahora;//COMPLETE
    }
    ...
    public Hora getHoraHH12(){
      ...
      if (this.formato == HH24) setFormato(HH12);
        ...
        copiahora.minutos = this.minutos;
        copiahora.segundos = this.segundos;
        copiahora.formato = HH12;
        copiahora.ampm = this.ampm;
      return copiahora;//COMPLETE
    }
    ...
    public int restar(Hora other){
        Hora estaH = this.getHoraHH24();
        Hora otraH = other.getHoraHH24();
        int segundero1 = estaH.horas * 3600 + estaH.minutos * 60 + estaH.segundos;
        int segundero2 = otraH.horas * 3600 + otraH.minutos * 60 + otraH.segundos;
      return segundero1 - segundero2;//COMPLETE
    }
    ...
    public boolean esIgual(Hora other){
      return restar(other) == 0;//COMPLETE
    }
