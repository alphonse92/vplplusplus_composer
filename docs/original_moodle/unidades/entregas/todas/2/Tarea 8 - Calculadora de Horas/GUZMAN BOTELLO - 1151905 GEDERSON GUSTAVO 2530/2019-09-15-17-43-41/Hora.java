...
public class Hora
{
    ...
    protected boolean esHoraValida(){
        ...
        if (horas < 0 || minutos < 0 || segundos <0 || minutos > 59 || segundos > 59 ||
           ((formato == HH12) && (horas > 12)) || ((formato == HH24) && (horas > 24)))
           horaValida = false;
    ...
    public boolean esIgual(Hora other){
        boolean sonIguales = restar(Hora other) == 0;
      return sonIguales;//COMPLETE
    }
