...
public class Hora
{
    ...
    public Hora getHoraHH24(){
        if(this.formato==HH12) setFormato(HH12);
    ...
    public Hora getHoraHH12(){
        if(this.formato==HH24) setFormato(HH24);
        Hora nuevaHora = new Hora(this.horas,this.minutos,this.segundos,this.formato,this.ampm);
        return nuevaHora;
    }
    ...
    public void setFormato(String formato){
        ...
        if(formato==HH24){
            if(this.horas>12&&(this.ampm!=AM&&this.ampm!=PM)){
                this.horas-=12;
                this.ampm=PM;
            }
            if(this.horas==0&&(this.ampm!=AM&&this.ampm!=PM)){
                this.horas+=12;
                this.ampm=AM;
            }
            if(this.horas>0&&this.horas<12&&(this.ampm!=AM&&this.ampm!=PM)){ 
                this.ampm=AM;
            }
            if(this.horas==12&&(this.ampm!=AM&&this.ampm!=PM)) this.ampm=PM;
            this.formato=HH12;            
        }
