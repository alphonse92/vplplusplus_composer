/** GRUPO 6: genesis daniela vargas Jáuregui -1151918
...
public class Restaurante extends Ingrediente {
    ...
    public void registrarCompraIngrediente(String nombre, int cantidad, int precioCompra, int tipo) {
        ...
        switch(tipo){
            case 1:
            ingrediente = new Fruta(nombre, cantidad, precioCompra); break;
            case 2:
            ingrediente = new Proteina(nombre, cantidad, precioCompra); break;
            case 3:
            ingrediente = new Grano(nombre, cantidad, precioCompra); break;
            case 4:
            ingrediente = new Almidon(nombre, cantidad, precioCompra); break;
            default:
            break;
        }
