...
public class Almuerzo {
    ...
    public int getPrecioVenta() {
        int precio = 0;
        precio += this.fruta.getPrecioCompra() * 30;
        precio += this.proteina.getPrecioCompra() * 200;
        precio += this.grano.getPrecioCompra() * 100;
        precio += this.almidon.getPrecioCompra() * 50;
