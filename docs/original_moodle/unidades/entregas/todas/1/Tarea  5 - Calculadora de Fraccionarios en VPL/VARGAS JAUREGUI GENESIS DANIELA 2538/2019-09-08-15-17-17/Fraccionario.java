/**
 * Un ejemplo de una calculadora de fraccionarios. Calcula todo, excepto PI.
 * 
 * @author (Milton Jesús Vera Contreras - miltonjesusvc@ufps.edu.c)
 * 
 * @Desarrolladores (Jhonny Guarín -jhonnyesneidergcha@ufps.edu.co && Génesis Vargas genesisdanielavjau@ufps.edu.co)
