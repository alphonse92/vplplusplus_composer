...
public class Fraccionario {
    ...
    public Fraccionario sumar(Fraccionario otro) {
        Fraccionario samir = new Fraccionario();
        samir.numerador=this.numerador*otro.denominador+otro.numerador*this.denominador;
        samir.denominador=this.denominador*otro.denominador;
        return samir;
    }//fin sumar
    ...
    public Fraccionario multiplicar(Fraccionario otro) {
        Fraccionario samir = new Fraccionario();
        samir.numerador=this.numerador*otro.numerador;
        samir.denominador=this.denominador*otro.denominador;
        return samir;
    }//fin multiplicar
    ...
    public Fraccionario dividir(Fraccionario otro) {
        Fraccionario samir = new Fraccionario();
        samir.numerador=this.numerador*otro.denominador;
        samir.denominador=this.denominador*otro.numerador;
        return samir;
    }//fin dividir 
    ...
    public void simplificar(){
     Fraccionario resul = new Fraccionario(this.numerador,this.denominador);
       ...
       denominador=denominador/a;  //COMPLETE SIMPLIFICAR
    }
