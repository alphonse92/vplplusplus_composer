...
public class CasaDeCambio {
    ...
    public boolean cambiarPrecioDelBolivar(float precioDeCompra, float precioDeVenta) {
        ...
        precioValido=precioDeVenta>precioDeCompra &&(precioDeVenta-precioDeCompra)>0 
        && precioDeVenta>0.0 && precioDeCompra>0.0;
        if(precioValido){
            this.precioDeCompra=precioDeCompra;
            this.precioDeVenta=precioDeVenta;
        }
    ...
    public float getImpuestos() {
        float impuestos;
        impuestos=0.16F*(this.precioDeVenta*this.bolivaresVendidos);
    ...
    public float getGanancias() {                
            return this.pesosEnCaja-getImpuestos();
    }//fin getGanancias
