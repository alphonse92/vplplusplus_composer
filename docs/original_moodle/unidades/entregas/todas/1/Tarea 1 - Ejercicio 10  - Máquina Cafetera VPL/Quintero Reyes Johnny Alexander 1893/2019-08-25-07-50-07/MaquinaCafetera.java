...
class MaquinaCafetera { 
    ...
    public boolean recargarAzucar(int cantidadAzucar, int costoCompraAzucar) {
      ...
      if(this.gananciasNetas>=costoCompraAzucar){
          ...
          this.egresos+=costoCompraAzucar*cantidadAzucar;
          return true;
        }else
      return false;
    }
    ...
    public boolean recargarVasos(int cantidadVasos, int costoCompraVasos) {
      ...
      if(this.gananciasNetas>=costoCompraVasos){
          ...
          this.egresos+=costoCompraVasos*cantidadVasos;
        }
      return true;
    }
    ...
    public boolean prepararCafe(int tipoCafe, int cantidadAzucar) {
        ...
        if(this.cafe>0 && this.azucar>0 && this.vasos>0 && this.precioBaseCafe>0){
      switch(tipoCafe){
         case 1:
          if(this.cafe>=55 && this.azucar>=5 && this.vasos>0 && this.precioBaseCafe>0){
            switch(cantidadAzucar){
             case 1:
             this.cafe-=55;
            ...
            case 2:
            if(this.cafe>=55*2 && this.azucar>=5 && this.vasos>0 && this.precioBaseCafe>0){
                switch(cantidadAzucar){
                    case 1:
                    this.cafe-=55*2;
                    break;
            ...
            break;
                case 3:
                if(this.cafe>=55*3 && this.azucar>=5 && this.vasos>0 && this.precioBaseCafe>0){
                switch(cantidadAzucar){
                    case 1:
                    this.cafe-=55*3;
                    break;
