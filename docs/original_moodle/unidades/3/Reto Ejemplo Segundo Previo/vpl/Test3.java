...
/**
 * Clase Test3 - Examen Final POO I 2017-I.
 *
...
public class Test3{
    ...
    @Test
    public void testTegistrarIngreso1()
    {
    ...
    @Test
    public void testTegistrarIngreso2()
    {
        Parqueadero p = new Parqueadero(v.length*4);
        Vehiculo[] ap = p.getVehiculos();
    ...
    @Test
    public void testTegistrarIngreso3()
    {
        Parqueadero p = new Parqueadero(v.length*4);
        Vehiculo[] ap = p.getVehiculos();
        Vehiculo[] ap2 = new Vehiculo[v.length*2]; 
    ...
    @Test
    public void testRegistrarIngreso4()
    {
        Parqueadero p = new Parqueadero(v.length*4);
        Vehiculo[] ap = p.getVehiculos();
