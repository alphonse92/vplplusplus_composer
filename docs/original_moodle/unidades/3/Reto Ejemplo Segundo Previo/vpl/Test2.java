...
/**
 * Clase Test2 - Examen Final POO I 2017-I.
 *
...
public class Test2
{
    ...
    public void testConstructor3()
    {
        ...
        boolean rta = false;
        try{
            new CarroGrande("URC789", "60458723", 25, 15, 20);
        }
        catch(Exception ex){
            e = ex;
        }
        assertNotNull("El constructor de Vehiculo y Hora deben validar y lanzar una excepcion si hay error.", e);
        e = null;
        try{
            new CarroPequeno("URC789", "60458723", 25, 15, 20);
        }
        catch(Exception ex){
            e = ex;
        }
        ...
        e = null;
        try{
            new Moto("URC789", "60458723", 25, 15, 20);
        }
        catch(Exception ex){
            e = ex;
        }
        ...
        e = null;
        try{
            new Bicicleta("URC789", "60458723", 25, 15, 20);
        }
        catch(Exception ex){
            e = ex;
        }
        ...
        e = null;
        try{
            new CarroGrande("URC789", "60458723", 22, 65, 20);
        }
        catch(Exception ex){
            e = ex;
        }
        ...
        e = null;
        try{
            new CarroPequeno("URC789", "60458723", 22, 15, 65);
        }
        catch(Exception ex){
            e = ex;
        }
    ...
    /*@Test
    public void testValorServicio(){
        Exception e = null;
        for(int i=0; i<v1.length; i++){
            try{
                v1[i].getValorTotalServicio();
            }
            catch(Exception ex){
                e = ex;
            }
    ...
    @Test
    public void testRegistrarSalida1(){
        Exception e = null;
    ...
    @Test
    public void testRegistrarSalida3(){
        Exception e = null;
        for(int i=0; i<v.length;i++){
            for(int j = 0; j<v.length;j++){
                e = null;
    ...
    @Test
    public void testRegistrarSalida4(){
        Exception e = null;
        for(int i=0; i<v.length;i++){
            for(int j = 0; j<v.length;j++){
                e = null;
