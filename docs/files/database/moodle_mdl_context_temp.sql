...
CREATE TABLE `mdl_context_temp` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPRESSED COMMENT='Used by build_context_path() in upgrade and cron to keep con';
...
-- Dump completed on 2019-11-17 20:32:01
