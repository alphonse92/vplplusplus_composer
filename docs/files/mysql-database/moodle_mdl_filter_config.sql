...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPRESSED COMMENT='Stores per-context configuration settings for filters which ';
...
-- Dump completed on 2019-11-17 20:31:24
