...
CREATE TABLE `mdl_quiz_statistics` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPRESSED COMMENT='table to cache results from analysis done in statistics repo';
...
-- Dump completed on 2019-11-17 20:33:10
