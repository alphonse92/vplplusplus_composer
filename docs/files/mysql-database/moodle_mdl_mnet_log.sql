...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPRESSED COMMENT='Store session data from users migrating to other sites';
...
-- Dump completed on 2019-11-17 20:32:57
