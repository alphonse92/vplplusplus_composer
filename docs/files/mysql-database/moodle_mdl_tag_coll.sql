...
CREATE TABLE `mdl_tag_coll` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPRESSED COMMENT='Defines different set of tags';
...
-- Dump completed on 2019-11-17 20:33:03
