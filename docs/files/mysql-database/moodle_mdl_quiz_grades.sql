...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPRESSED COMMENT='Stores the overall grade for each user on the quiz, based on';
...
-- Dump completed on 2019-11-17 20:32:04
